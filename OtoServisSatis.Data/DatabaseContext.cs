...
namespace OtoServisSatis.Data
{
	public class DatabaseContext:DbContext
	{
		...
		{
			optionsBuilder.UseSqlServer(@"server=DESKTOP-34Q6CN8\SQLEXPRESS01; database=OtoServisSatisNetCore;
				TrustServerCertificate=True;integrated security=True; MultipleActiveResultSets=True;");
